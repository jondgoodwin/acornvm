...
LIBNAME   =avmlib
OBJECTS   = avm_api.o avm_table.o avm_memory.o avm_array.o avm_string.o avm_symbol.o avm_value.o avm_thread.o avm_stack.o avm_func.o avm_global.o avm_vm.o
TESTOBJS  = testavm.o
TESTEXE   =testavm
